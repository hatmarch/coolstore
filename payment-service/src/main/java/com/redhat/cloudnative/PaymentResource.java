...
public class PaymentResource {
    ...
    public CompletionStage<Void> onMessage(KafkaRecord<String, String> message) throws IOException {
        ...
        System.out.println(String.format("Kafka message with value = %s arrived", message.getPayload()));
    ...
    private void pass(String orderId, String paymentId, String remarks) 
    {
        ...
        payload.put("status", "COMPLETED (Standard Service)");
    ...
    {
        JsonObject payload = createPayment(orderId, paymentId, remarks);
        payload.put("status", "FAILED (Standard Service)");
